...
FidReadReal = fopen('EchoRealEle.dat','r');
FidReadImage= fopen('EchoImagEle.dat','r');
FidWriteReal= fopen('RanCompRealEle.dat','w');
FidWriteImage= fopen('RanCompImageEle.dat','w');

...
process_adc=zeros(numADCSamples,numChirps/4);

for nchirp = 1:4:numChirps  %2T4R 但只用了TX1 一个通道 2*200*1024=200* 2048,如果用TX1和 TX2则为4*200*1024=200*4096
...
breath_count =(fs*(1024-(breath_index-1))/2048)*60; %呼吸频率解算
...
heart_count =(fs*(1024-(heart_index-1))/2048)*60;%心跳频率解算

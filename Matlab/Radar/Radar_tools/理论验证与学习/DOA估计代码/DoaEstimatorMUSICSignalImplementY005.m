function [spatialSpectrum, doas]  = DoaEstimatorMUSICSignalImplementY005(recStvPartition, rxSigNoise, PilotSequence, AzimuthScanAngles, MaxNumSig, FilterFlag) %#codegen
...
spatialSpectrum = 1./abs(sum((recStvPartition'*Rnn).'.*recStvPartition));

...
% L2_DISTANCE - computes Euclidean distance matrix计算欧几里德距离矩阵
%
% E = L2_distance(A,B)
%
%    A - (DxM) matrix 
...
% 
% Returns:
%    E - (MxN) Euclidean distances between vectors in A and B欧氏距离在A和B之间的向量
%
%
% Description : 
%    This fully vectorized (VERY FAST!) m-file computes the 
%    Euclidean distance between two vectors by:
%这个完全向量化（VERY FAST！）m文件通过以下方式计算两个向量之间的欧几里得距离：
%

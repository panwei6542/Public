...
＃unsupervised_learning_of_action_manifolds
该库包含MATLAB代码和例程，用于运行ISVC 2016论文和论文中介绍的无监督学习算法。相关的会议文件是2016年国际视觉计算研讨会（ISVC 2016）上发表的“无监督深度网络，用于视频流中人的行为的时间本地化”。如果使用任何部分代码或想法，请引用以下来源。谢谢。

1）Nair，Binu M.“无监督深度网络在流媒体视频中对人类行为进行时间定位”。在视觉计算国际研讨会，143-155页。 Springer International Publishing，2016.（https://link.springer.com/chapter/10.1007%2F978-3-319-50832-0_15）

2）Nair，Binu Muraleedharan。 “学习潜在时间流形用于识别和预测使用深度网络的流式视频中的多个动作”。 2015年代顿大学博士学位（https://etd.ohiolink.edu/pg_10?0::NO:10:P10_ACCESSION_NUM:dayton1429532297）

此外，该代码是基于Geoffrey Hinton网页上的“rbm”代码开发的，用于对MNIST数据上的自动编码器进行培训。 （http://www.cs.toronto.edu/~hinton/MatlabForSciencePaper.html）。使用CRBM的时间学习是基于早期版本的CRBM代码来模拟Graham Taylor的运动风格。这是他更新的Git仓库：https：//github.com/gwtaylor/imCRBM。

如果使用这个工作，也请引用他们的相关论文。

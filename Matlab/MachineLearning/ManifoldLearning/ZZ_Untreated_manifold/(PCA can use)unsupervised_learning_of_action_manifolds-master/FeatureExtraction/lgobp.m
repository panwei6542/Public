%LBP returns the local gradient orientation binary pattern image or LBP histogram of an image.
...
function result = lgobp(varargin) % image,radius,neighbors,mapping,mode)
% Version 0.3.2

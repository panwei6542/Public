...
If you want to use this package please cite 
	...
	"Data-driven input variable selection for rainfall鈥搑unoff modeling using 
...
elm_matlabclass是极端学习机快速的MATLAB的面向对象实现
黄等人提出的。，

黄，广斌，秦宇竹，Chee Kheong Siew。
极限学习机：理论与应用。
神经计算70.1（2006）：489-501。

黄，广斌等。”回归学习的极限学习机
多类分类。系统、人与控制论。B辑：控制论，
IEEE 42.2（2012）：513-529。

如果您想使用这个软件包，请举例说明。

陶尔米纳，里卡尔多，Kwok Wing Chau。
“数据驱动的输入变量选择降雨鈥搑非入药典进行建模
二进制编码粒子群优化和极限学习机。
水文杂志529（2015）：1617-1632。
...
1）elm_matlabclass。M，这是课堂实施的榆树；

2）example_classification。M，它展示了如何使用榆二元分类；

3）example_regression。M，它展示了如何使用ELM的回归问题；

4）computeaccuracy。m，计算分类精度的榆树；

5）电脑。m，计算决定系数（R ^ 2）；

6）readme.md，这个文件；

7）许可证，TXT，GNU GPL许可证。

UCI数据集和data_akbilgic.csv也breast-cancer-wisconsin.data
包括在分类和回归的例子中，
分别。这些数据集可在http。
有关数据集的进一步信息，请参阅UCI网站。